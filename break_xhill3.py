...
sample_ctext = 'hwduyfsfqdxnx nx ymj fwy tk gwjfpnsl htijx fsi hnumjwx. bmjs fyyjruynsl yt hwfhp f mnqq hnumjw, kwjvz' \
               'jshd fsfqdxnx bnqq gj uwfhynhfqqd zxjqjxx'
...
class NBest(object):
    ...
    def add(self, item):
        ...
        if len(self.store) > 2 * self.N: self.finalise()
...
def break_xhill3(ctext, N=100):
    ...
    for j in range(N):
        ...
        for seq in product(range(26), repeat=4):
            ...
            seq2 = (seq[0], seq[1], seq[2], rec2[j][1][0], rec2[j][1][1], rec2[j][1][2], rec2[j][1][3], rec2[j][1][4],
                    rec2[j][1][5])
            da = (seq2[0] * seq2[4] * seq2[8] + seq2[1] * seq2[5] * seq2[6] + seq2[2] * seq2[3] * seq2[7]) - (
                    seq2[2] * seq2[4] * seq2[6] + seq2[1] * seq2[3] * seq2[8] + seq2[0] * seq2[5] * seq2[7])
            if da % 2 != 0 and da % 13 != 0:
...
if __name__ == '__main__':
    ...
    break_xhill3(args.ctext, args.N)
